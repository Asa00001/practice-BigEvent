...
const articleList = async () => {
    ...
    //处理数据，给数据类型扩展一个属性categoryName，分类名称
    ...
    <el-card class="page-container">
        <template #header>
            <div class="header">
                <span>文章管理</span>
                <div class="extra">
                    <el-button type="primary" @click="isEdit = false; visibleDrawer = true">添加文章</el-button>
                </div>
            </div>
        </template>
        <!-- 搜索表单 -->
            ...
            <el-form :model="articleModel" label-width="100px">
                ...
                <el-form-item label="文章内容">
                    <div class="editor">
                        ...
                        <quill-editor 
                        ref="editorRef" theme="snow" v-model:content="articleModel.content" contentType="html">
                        </quill-editor>
                    </div>
                </el-form-item>
                <el-form-item>
                    <el-button type="primary" @click="isEdit ? updateArticle('已发布') : addArticle('已发布')">发布</el-button>
                    <el-button type="info" @click="isEdit ? updateArticle('草稿') : addArticle('草稿')">草稿</el-button>
                </el-form-item>
            </el-form>
        </el-drawer>
    </el-card>
